...
class Localizer(Parente):
    def __init__(self, duration, betweenstimuli, number_of_block, number_per_block, trigger,  output):
...
if __name__ == "__main__":
    ...
    localizer = Localizer(args.duration,args.betweenstimuli,args.blocks,args.per_block,  args.trigger, args.output_file)
    localizer.lancement()
